...
''' These are now imported dynamically based on scenario and sandbox '''
...
class AdvantEDGEApi(object):
    def __init__(self, sandbox = None, scenario = None, **kwargs):
        ...
        global monclient
        global client
        mconsole("Configuring sandbox={} scenario={}".format(sandbox,scenario))
        ...
        try:
            ...
            mconsole("Could not import the client APIs for sandbox {} and scenario {}".format(sandbox,scenario),level="ERROR")
